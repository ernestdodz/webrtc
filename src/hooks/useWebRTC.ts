...
export const useWebRTC = () => {
  ...
  const connectToRandomPeer = useCallback(async () => {
    ...
    connectSignaling();
  }, [connectSignaling, disconnectPeer, initLocalStream, initPeerConnection, localStream]);
  ...
  }, [createOffer, disconnectPeer, handleAnswer, handleIceCandidate, handleOffer, onSignalReceived]);
